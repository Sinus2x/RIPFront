            ...
            >
                {({ handleSubmit }) => (
                    <>
                        ...
                        <span>Альбом</span>
                        <InputField name="name" placeholder="Альбом" />
                        <span>Группа</span>
                        <InputField name="type" placeholder="Группа" />
                        <span>Жанр</span>
                        <InputField name="brand" placeholder="Жанр" />
                        <span>Популярность</span>
                        <InputField name="strength" placeholder="Популярность" type="number" max={10} min={1} />
                        <span>Цена</span>
